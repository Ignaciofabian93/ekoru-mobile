...
import useLocationStore, { useDetectedLocation, useIsLocationConfirmed } from "@/store/useLocationStore";
      ...
      <View style={styles.backdrop}>
        <View style={styles.sheet}>
          ...
          <View style={styles.actions}>
            <MainButton text={t("location.confirm")} onPress={handleConfirm} style={styles.confirmButton} />
            <Pressable style={styles.dismissButton} onPress={handleDismiss}>
              <Text style={styles.dismissText}>{t("location.notMyLocation")}</Text>
            </Pressable>
          </View>
        </View>
      </View>
